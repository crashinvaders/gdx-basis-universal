 ...
 * 
 * @author mzechner */
public class PatchedNativeCodeGenerator {
	 ...
	 * @throws Exception */
	public void generate (String sourceDir, String jniDir) throws Exception {
		generate(sourceDir, jniDir, null, null);
	}
	 ...
	 * @throws Exception */
	public void generate (String sourceDir, String jniDir, String[] includes, String[] excludes)
		throws Exception {
		...
		for (FileDescriptor file : files) {
			if (file.isDirectory()) {
				...
				if (file.extension().equals("java")) {
					...
					String fileName = className.replace('.', '_'); // use underscore in file names to match "javac -h" output file names.
					FileDescriptor hFile = new FileDescriptor(jniDir.path() + "/" + fileName + ".h");
					FileDescriptor cppFile = new FileDescriptor(jniDir + "/" + fileName + ".cpp");
