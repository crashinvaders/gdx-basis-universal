...
/**
 * Loads and displays a variety of Basis Universal/KTX2 textures
 * (plain, atlas-packed and mipmapped, across ETC1S and UASTC) side by side.
 */
public class TextureGalleryScreen implements Screen {
    private static final String TAG = TextureGalleryScreen.class.getSimpleName();
    ...
    public TextureGalleryScreen(App app) {
        this.app = app;
