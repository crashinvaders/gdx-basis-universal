...
public class BasisuImageLevelInfo implements Closeable {
	/*JNI
        ...
        static basist::basisu_image_level_info* getWrapped(jlong addr) {
            return (basist::basisu_image_level_info*)addr;
        }
	 */
...
//    }
    ...
    */
    ...
    private static native long jniCreate(); /*
       basist::basisu_image_level_info* imageInfo = new basist::basisu_image_level_info();
       return reinterpret_cast<intptr_t>(imageInfo);
    */

    private static native void jniDispose(long addr); /*
		basist::basisu_image_level_info* imageInfo = (basist::basisu_image_level_info*)addr;
		delete imageInfo;
	*/
}
