 ...
 * <p/>
 */
public interface Ktx2TextureFormatSelector {

    /** Default texture format selector to be used by all the {@link Ktx2TextureData} instances. */
    public static Ktx2TextureFormatSelector defaultSelector = new Default();
     ...
     * for Android devices.
     */
    class Default implements Ktx2TextureFormatSelector {
        ...
        private BasisuTranscoderTextureFormat resolveTextureFormat(BasisuTextureFormat textureFormat, int width, int height, boolean hasAlpha) {
            ...
            if (textureFormat == BasisuTextureFormat.ETC1S) {
                if (hasAlpha) {
...
//                }
            ...
            } else if (textureFormat == BasisuTextureFormat.ETC1S) {
                if (hasAlpha) {
                    // The color block will be ETC1S, and the alpha block is EAC.
                    // Conversion from ETC1S->EAC is very fast and nearly lossless.
                    if (isBasisuFormatSupported(ETC2_RGBA, textureFormat)) {
